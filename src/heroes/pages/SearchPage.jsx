        ...
        <div className='row'>
          ...
          <div className='col-7'>
            ...
            {/* {
              ...
              : ( heroes.length === 0 ) && <div className='alert alert-danger'>No hero found with name: { q }</div>
            } */}

            <div className='alert alert-primary animate__animated animate__fadeIn' style={{ display: showSearch ? '' : 'none' }}>Search a hero</div>
            <div className='alert alert-danger animate__animated animate__fadeIn' style={{ display: showError ? '' : 'none' }}>No hero found with name: { q }</div>
            {
              heroes.map( hero => (
